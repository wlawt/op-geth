...
func (e ExecutableData) MarshalJSON() ([]byte, error) {
	type ExecutableData struct {
		...
		AggregatedSig hexutil.Bytes       `json:"aggregatedSig" gencodec:"required"`
	}
	...
	enc.AggregatedSig = e.AggregatedSig
...
func (e *ExecutableData) UnmarshalJSON(input []byte) error {
	...
	if dec.AggregatedSig == nil {
		return errors.New("missing required field 'aggregatedSig' for ExecutableData")
	}
	e.AggregatedSig = *dec.AggregatedSig
	return nil
}
